        ...
        <Container>
            <div className='navv'>
                <Row>
                    ...
                    <Col className='col-6 '>
                     <input  type="text" placeholder='Aradığınız kategori,marka ya da ürünü yazınız' /> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
